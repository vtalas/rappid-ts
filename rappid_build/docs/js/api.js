...
(function() {
    ...
    var iframes;
    var topLevelNavItems = document.querySelectorAll('.docs-nav > .docs-nav-items > .docs-nav-item');
    ...
    function initializeNavSearch() {
        ...
        function closeAll() {
            ...
            for (var i = 0; i < topLevelNavItems.length; i++) {
                removeClassFromEl(topLevelNavItems[i], 'open');
            }
        }
        ...
        function showItemsThatMatch(value) {
            ...
            for (i = 0; i < topLevelNavItems.length; i++) {
                addClassToEl(topLevelNavItems[i], 'open');
            }
        }

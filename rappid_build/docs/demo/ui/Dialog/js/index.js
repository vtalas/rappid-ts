...
$(function() {
    ...
    $('#open-draggable').on('click', function() {
    ...
    $('#open-notitle-nobuttons').on('click', function() {
    ...
    $('#open-nomodal').on('click', function() {

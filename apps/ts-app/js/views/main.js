...
var joint = require("../../../../build/rappid");
var App = window['App'] || {};
var MainView = (function (_super) {
    ...
    // events: {
    //     'focus input[type="range"]': ((evt:Event) =>  {evt.target.blur());
    // };
    ...
    MainView.prototype.initializePaper = function () {
    ...
    MainView.prototype.initializeStencil = function () {
    ...
    MainView.prototype.initializeKeyboardShortcuts = function () {
    ...
    MainView.prototype.initializeSelection = function () {
    ...
    MainView.prototype.createInspector = function (cell) {
        return joint.ui.Inspector.create('.inspector-container', _.extend({
            cell: cell
        }, App.config.inspector[cell.get('type')]));
    };
    MainView.prototype.initializeHaloAndInspector = function () {
    ...
    MainView.prototype.initializeNavigator = function () {
    ...
    MainView.prototype.initializeToolbar = function () {
    ...
    MainView.prototype.changeSnapLines = function (checked) {
        if (checked) {
    ...
    MainView.prototype.initializeTooltips = function () {
    ...
    MainView.prototype.openAsSVG = function () {
    ...
    MainView.prototype.openAsPNG = function () {
    ...
    MainView.prototype.onMousewheel = function (cellView, evt, x, y, delta) {
        if (this.keyboard.isActive('alt', evt)) {
            evt.preventDefault();
            this.paperScroller.zoom(delta * 0.2, { min: 0.2, max: 5, grid: 0.2, ox: x, oy: y });
        }
    };
    MainView.prototype.layoutDirectedGraph = function () {
        joint.layout.DirectedGraph.layout(this.graph, {
            setLinkVertices: function () { return true; },
            rankDir: 'TB',
            marginX: 100,
            marginY: 100
        });
